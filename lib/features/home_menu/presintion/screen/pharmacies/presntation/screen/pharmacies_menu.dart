...
import '../component/pharmacies_item.dart';

class PharmaciesMenu extends StatelessWidget {
  const PharmaciesMenu({Key? key}) : super(key: key);
                ...
                Row(
                  children: [
                    Padding(
                      ...
                      child: Center(
                        child: Text(AppString.pharmacies.tr(context),
                          style: TextStyle(
