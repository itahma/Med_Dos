...
class PharmaciesItemComponent extends StatelessWidget {
  const PharmaciesItemComponent({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return InkWell(
      onTap: (){
        navigate(context: context, route: Routes.pharmaciesDetails);
        ...
        child: Row(
          children: [
            ...
            const Column(
              ...
              children: [
                Text('Name Pharmacies',style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold),),
                SizedBox(height: 10,),
