...
import 'package:med_dos/features/home_menu/presintion/screen/healthCenters_detalis/presentation/screens/doctors/doctor_center_details.dart';

class DoctorCenterItemComponent extends StatelessWidget {
  DoctorCenterModel doctorModel;
  DoctorCenterItemComponent({Key? key,required this.doctorModel}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return InkWell(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(builder: (_)=>DoctorCenterDetails(doctorModel)));
            ...
            SizedBox(
             ...
             Column(
              ...
              children: [
                ...
                Text(doctorModel.specialist,style: TextStyle(fontSize: 14),),
