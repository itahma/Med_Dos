...
class LaboratoriesItemComponent extends StatelessWidget {
  const LaboratoriesItemComponent({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return InkWell(
      onTap: (){
        navigate(context: context, route: Routes.laboratoriesDetails);
        ...
        child: Row(
          children: [
            ...
            const Column(
              ...
              children: [
                Text('Name Laboratories',style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold),),
                SizedBox(height: 10,),
