...
import '../component/laboratories_item_component.dart';
class LaboratoriesCentersMenu extends StatelessWidget {
  const LaboratoriesCentersMenu({Key? key}) : super(key: key);
                ...
                Row(
                  children: [
                    Padding(
                      ...
                      child: Center(
                        child: Text(AppString.laboratories.tr(context),
                          style: TextStyle(
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) => const Padding(
                        ...
                        child: LaboratoriesItemComponent()),
                  ),
                ),
              ],
            ),
